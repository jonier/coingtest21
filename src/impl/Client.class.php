...
class Client
{
  ...
  */
  ...
  {
    /*
        url      = 'https://api.gocoin.com/api/v1/merchants/07c68b85-5b65-44df-89e3-4db03782e273/invoices'
        $params  = '{"price_currency":"BTC","base_price":"21","base_price_currency":"USD"}'
    
        $headers = array (size=3)
                      'Content-Type' => string 'application/json' (length=16)
                      'Cache-Control' => string 'no-cache' (length=8)
                      'Authorization' => string 'Bearer e7471472090fbc4507b6418b361e8290b1630666900e3f6ac8d5ed19819a2779'
